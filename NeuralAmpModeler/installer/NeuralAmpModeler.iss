...
AppVersion=0.7.16
VersionInfoVersion=0.7.16
DefaultDirName={pf}\Puke Amp
DefaultGroupName=Puke Amp
Compression=lzma2
SolidCompression=yes
OutputDir=.\..\build-win\installer
ArchitecturesInstallIn64BitMode=x64
OutputBaseFilename=Puke Amp Installer
...
[Messages]
WelcomeLabel1=Welcome to the Puke Amp installer
SetupWindowTitle=Puke Amp installer
...
;Name: "{cf32}\VST3\Puke Amp.vst3\"; Attribs: readonly; Components:vst3_32;
Name: "{cf64}\VST3\Puke Amp.vst3\"; Attribs: readonly; Check: Is64BitInstallMode; Components:vst3_64;

[Files]
;Source: "..\build-win\NeuralAmpModeler_Win32.exe"; DestDir: "{app}"; Check: not Is64BitInstallMode; Components:app; Flags: ignoreversion;
Source: "..\build-win\Puke Amp_x64.exe"; DestDir: "{app}"; Check: Is64BitInstallMode; Components:app; Flags: ignoreversion;
...
;Source: "..\build-win\Puke Amp.vst3\*.*"; Excludes: "\Contents\x86_64\*,*.pdb,*.exp,*.lib,*.ilk,*.ico,*.ini"; DestDir: "{cf32}\VST3\Puke Amp.vst3\"; Components:vst3_32; Flags: ignoreversion recursesubdirs;
;Source: "..\build-win\Puke Amp.vst3\Desktop.ini"; DestDir: "{cf32}\VST3\Puke Amp.vst3\"; Components:vst3_32; Flags: overwritereadonly ignoreversion; Attribs: hidden system;
;Source: "..\build-win\Puke Amp.vst3\PlugIn.ico"; DestDir: "{cf32}\VST3\Puke Amp.vst3\"; Components:vst3_32; Flags: overwritereadonly ignoreversion; Attribs: hidden system;

; 64-bit install: exclude 32-bit arch folder only (iPlug uses x86-win / x86_64-win, not "x86").
Source: "..\build-win\Puke Amp.vst3\*.*"; Excludes: "\Contents\x86-win\*,*.pdb,*.exp,*.lib,*.ilk,*.ico,*.ini"; DestDir: "{cf64}\VST3\Puke Amp.vst3\"; Check: Is64BitInstallMode; Components:vst3_64; Flags: ignoreversion recursesubdirs;
Source: "..\build-win\Puke Amp.vst3\Desktop.ini"; DestDir: "{cf64}\VST3\Puke Amp.vst3\"; Check: Is64BitInstallMode; Components:vst3_64; Flags: overwritereadonly ignoreversion; Attribs: hidden system;
Source: "..\build-win\Puke Amp.vst3\PlugIn.ico"; DestDir: "{cf64}\VST3\Puke Amp.vst3\"; Check: Is64BitInstallMode; Components:vst3_64; Flags: overwritereadonly ignoreversion; Attribs: hidden system;
Source: "ThirdPartyNotices.txt"; DestDir: "{cf64}\VST3\Puke Amp.vst3\Contents\Resources"; Check: Is64BitInstallMode; Components:vst3_64; Flags: ignoreversion;
...
[Icons]
Name: "{group}\Puke Amp"; Filename: "{app}\Puke Amp_x64.exe"
Name: "{group}\User guide"; Filename: "{app}\NeuralAmpModeler manual.pdf"
Name: "{group}\Changelog"; Filename: "{app}\changelog.txt"
;Name: "{group}\readme"; Filename: "{app}\readme.rtf"
Name: "{group}\Uninstall Puke Amp"; Filename: "{app}\unins000.exe"
